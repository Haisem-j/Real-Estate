...
export default class Filter extends Component {
  ...
  cities(){
      if(this.props.globalState.populateForms !== undefined){
        var {city} = this.props.globalState.populateForms
    ...
    homeTypes(){
      ...
      if(this.props.globalState.populateForms !== undefined){
        var {homeTypes} = this.props.globalState.populateForms
    ...
    bedrooms(){
      if(this.props.globalState.populateForms !== undefined){
        var {bedrooms} = this.props.globalState.populateForms
        ...
        <span className="title">
          Extras
            ...
            <label htmlFor="extras">
              ...
              <input name="swimminng_pool" value="swimminng_pool" type="checkbox" onChange={this.props.change}/>
            </label>
            <label htmlFor="extras">
